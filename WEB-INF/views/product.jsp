...
<div class="form-group">
  <label class="col-md-4 control-label" for="product_name">PRODUCT TYPE</label>  
  <div class="col-md-4">
  <pf:hidden path="id"/>
...
<!-- Button -->
<div class="form-group">
  <label class="col-md-4 control-label" for="singlebutton">ADD PRODUCT TYPE</label>
  <div class="col-md-4">
...
<table class="table table-bordered">
			...
			<td>${p.id}</td>
		    <td>${p.pname}</td>
	        <td><a href="${context}/editcategory/${p.id}"> <div class="col-md-4">
    <button id="singlebutton" name="singlebutton" class="btn btn-primary">Edit</button>
  </div></a></td>
					<td><a href="deletecategory/${p.id}"> <div class="col-md-4">
