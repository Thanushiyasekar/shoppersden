...
<h1>Need Login credential to add products in the cart</h1>
</security:authorize>
    <div class="row">
					...
					<div class="caption">
						...
						<div class="row">
							...
							<div class="col-md-6">
                             ...
                             <security:authorize access="isAnonymous()">
                                <a href="${pageContext.request.contextPath}/login" class="btn btn-success btn-product"><span class="glyphicon glyphicon-shopping-cart"></span> Buy</a></div>
